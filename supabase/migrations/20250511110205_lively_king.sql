/*
  # Fix database functions and type casting

  1. New Functions
    - `exec_sql`: Executes dynamic SQL queries with proper security checks
    - `get_representative_total_sales`: Fixed type casting for month parameter

  2. Security
    - Added security definer to exec_sql function
    - Added proper security checks for SQL injection prevention
    - Limited exec_sql to authenticated users only
*/
