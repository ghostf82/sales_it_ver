/*
  ...
  1. Changes
    - Add function to calculate commission based on tiered system
    - Handle all edge cases and validation
    - Return precise calculations
    
  2. Security
    - Function is immutable and stable
