/*
  ...
  1. Changes
    - Create commission_rules table with proper constraints
    - Add RLS policies with existence checks
    - Add functions for commission calculation
...
DROP FUNCTION IF EXISTS calculate_tiered_commission(text, numeric, numeric);
