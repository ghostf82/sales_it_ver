...
DROP POLICY IF EXISTS "inputs_read_policy_v2" ON inputs;
DROP POLICY IF EXISTS "inputs_insert_policy_v2" ON inputs;
DROP POLICY IF EXISTS "inputs_update_policy_v2" ON inputs;
DROP POLICY IF EXISTS "inputs_delete_policy_v2" ON inputs;
...
CREATE POLICY "inputs_read_policy_v3"
  ON inputs
  FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "inputs_insert_policy_v3"
  ON inputs
  FOR INSERT
  TO authenticated
  WITH CHECK (
...
CREATE POLICY "inputs_update_policy_v3"
  ON inputs
  FOR UPDATE
  TO authenticated
  USING (
...
CREATE POLICY "inputs_delete_policy_v3"
  ON inputs
  FOR DELETE
  TO authenticated
  USING (
